...
app.use("/api/queryForTestTotalQuantityRouter", queryForTestTotalQuantityRouter);
app.use("/api/queryForPartsQuantityQuantityRouter", queryForPartsQuantityQuantityRouter);
app.use("/api/queryForLocationQuantityRouter", queryForLocationQuantityRouter);
app.use("/api/queryForLocationQuantity2Router",queryForLocationQuantity2Router);
