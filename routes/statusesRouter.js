...
statusRouter.get("/", authenticate, (req, res) => {
...
//add status to table
statusRouter.post("/add", authenticate, async (req, res) => {
...
statusRouter.post("/edit", authenticate, async (req, res) => {
...
statusRouter.post("/delete", authenticate, async (req, res) => {
